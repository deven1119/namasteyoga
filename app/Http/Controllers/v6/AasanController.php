...
{   
   public function getSubCategoryList(Request $request)
   {
      ...
      {     
               ...
               else
               {
                  ...
                  {
                     $sub_category_data=[];
                     $sub_category_list=AasanaSubCategory::where('aasana_categories_id',$category->id)->select('id','aasana_categories_id','subcategory_name','subcategory_description','subcategory_image')->get(); 
   ...
   {    
      ...
      {
              return response()->json([
               'StatusCode'=>$status['NP_STATUS_NOT_KNOWN'],                                 
           ]);
      }
